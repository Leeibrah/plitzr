...
<nav>
	<ul>
		<li><a href="../../../bobble-shop.php" class="js-loading">Home</a></li>
						<li class="separator"><!-- --></li>
						<li class="categories-wrapper">
							<div class="select-category"><span><?php echo "$product->product_name" ?></span> <em><!-- --></em></div>
							<ul class="categories">
...
<article class="product-view">
	<form method="post" action="../../../cart.php" accept-charset="utf-8"><div style="display:none;">
		<input type="hidden" name="_method" value="POST" /></div>		
		<input type="hidden" name="data[Product][id]" value="<?php echo "$product->id" ?>" id="ProductId" />		
		<input type="hidden" name="data[Product][slug]" value="<?php echo "$product->product_name" ?>" id="ProductSlug" />		
		<input type="hidden" name="data[Product][title]" value="<?php echo "$product->product_name" ?>" id="ProductTitle" />		
		<input type="hidden" name="data[Product][price]" value="<?php echo "$product->product_price" ?>" id="ProductPrice" />		
		<input type="hidden" name="data[Shop][Currency][code]" value="KSH" id="ShopCurrencyCode" />		
		<input type="hidden" name="data[Product][add_to_cart]" value="1" id="ProductAddToCart" />		
		<input type="hidden" name="data[Shop][id]" value="<?php echo "$product->id" ?>" id="ShopId" />		
		<input type="hidden" name="data[Shop][slug]" value="<?php echo "$product->product_name" ?>" id="ShopSlug" />
		<div class="col-right">
			...
			<div class="fb-box title-box">
				<div class="fb-box-inner">
					...
					<div class="variations">					
						<input type="hidden" name="data[ProductVariation][id]" value="52839" id="ProductVariationId" /><div class="input select product-variation" id=""><label for=""> Kenyan tshirt size :</label><select id="" class="product-variation-select"><option value="52839" selected>small&nbsp; </option><option value="52840">large&nbsp; </option></select></div>					</div>

					<div class="prices">
						<dl>
							<dt>Price</dt>
							<dd>Ksh. <?php echo "$product->product_price" ?></dd>
						</dl>
...
<div class="fb-box ui-gallery">									
	<a class="img large-btn clr" href="pink.htm#" data-src-xl=""><img src="<?php echo "images/$product->big_pic_url"; ?>" class="large" alt="" /></a>
	<a href="bobble-brush-pink.htm" class="img thumb-btn" data-src-l="" data-src-xl="17193/bobble_brush_018764_x2_white_pink_small_rgb_xxl.jpg"><img src="<?php echo "images/$product->big_pic_url"; ?>" alt="bobble brush pink" class="thumb" /></a>
	<a href="bobble-brush-pink.htm#" class="img thumb-btn" data-src-l="" data-src-xl=""><img src="<?php echo "images/$product->big_pic_url"; ?>" alt="bobble brush pink" class="thumb" /></a></div>		
		<div class="fb-box">
